...
const TIMELINE_EVENTS = [
  ...
  // ═══════════════════════════════════════════════════════
  { year: 2026, month: 6, day: 11, pillar: "pop", title: "FIFA World Cup 2026", desc: "Größte WM aller Zeiten. 48 Teams, 3 Länder: USA, Kanada, Mexiko. Finale im MetLife Stadium New Jersey.", type: "forecast", confirmed: true, side: "right", size: "large" },
  { year: 2027, month: 4, day: 25, pillar: "culture", title: "Frankreich Présidentielle", desc: "Macrons zweite Amtszeit endet. Neuwahl entscheidet Europas politische Richtung für die nächste Dekade.", type: "forecast", confirmed: true, side: "left", size: "medium" },
  { year: 2027, month: 5, day: 7, pillar: "pop", title: "Avengers: Secret Wars", desc: "Marvel Kino-Finale des Multiverse Saga. Offiziell angekündigt für Mai 2027. Größtes Ensemble der MCU Geschichte.", type: "forecast", confirmed: true, side: "right", size: "large" },
  ...
  { year: 2028, month: 7, day: 14, pillar: "pop", title: "Olympische Spiele Los Angeles", desc: "Sommer 2028. LA Olympic Games. Erste Spiele in den USA seit Atlanta 1996. Neue Sportarten, Record Audience.", type: "forecast", confirmed: true, side: "right", size: "large" },
  { year: 2028, month: 11, day: 7, pillar: "culture", title: "US Presidential Election", desc: "Nächste Wahl ins Weiße Haus. Nach zwei Trump Amtszeiten entscheidet sich die Richtung der USA für eine Generation.", type: "forecast", confirmed: true, side: "left", size: "large" },
  ...
  { year: 2030, month: 6, day: 13, pillar: "pop", title: "FIFA World Cup 2030", desc: "100 Jahre WM Jubiläum. Austragungsorte: Spanien, Portugal, Marokko plus Argentinien und Uruguay. Historisches Event.", type: "forecast", confirmed: true, side: "left", size: "large" },
  ...
  { year: 2026, month: 5, day: 1, pillar: "pop", title: "Avengers: Doomsday", desc: "Marvel Mega Film. Robert Downey Jr. kehrt als Doctor Doom zurück. Multiverse Saga Höhepunkt vor Secret Wars.", type: "forecast", confirmed: true, confidence: 95, side: "left", size: "large" },
  { year: 2026, month: 5, day: 16, pillar: "pop", title: "Eurovision Song Contest Wien", desc: "Österreich Gastgeber nach JJs Sieg 2025. Wien Stadthalle. Über 200 Millionen Zuschauer global.", type: "forecast", confirmed: true, confidence: 75, side: "right", size: "medium" },
  ...
  { year: 2026, month: 5, day: 22, pillar: "pop", title: "Star Wars: The Mandalorian & Grogu", desc: "22. Mai 2026. Erster Mandalorian Kinofilm. Pedro Pascal mit Baby Yoda zurück auf der Leinwand.", type: "forecast", confirmed: true, confidence: 80, side: "left", size: "medium" },
  ...
  { year: 2026, month: 7, day: 17, pillar: "pop", title: "Christopher Nolan: The Odyssey", desc: "17. Juli 2026. Matt Damon als Odysseus. IMAX 70mm Epos nach Oppenheimer. Eines der wichtigsten Filme der Dekade.", type: "forecast", confirmed: true, confidence: 88, side: "right", size: "large" },
  ...
  { year: 2026, month: 8, day: 22, pillar: "pop", title: "Coldplay Music of the Spheres Finale", desc: "22. August. Wembley Stadium London. Größte Tour der Bandgeschichte endet nach 4 Jahren und 200 Shows.", type: "forecast", confirmed: true, confidence: 70, side: "right", size: "medium" },
  ...
  { year: 2026, month: 11, day: 3, pillar: "culture", title: "US Midterm Elections", desc: "3. November. 435 House Sitze, 35 Senate Seats. Erste Bewertung der zweiten Trump Amtszeit. Indikator für 2028.", type: "forecast", confirmed: true, confidence: 95, side: "left", size: "large" },
  { year: 2026, month: 11, day: 20, pillar: "pop", title: "Hunger Games: Sunrise on the Reaping", desc: "20. November. Prequel zu Catching Fire. Haymitch Abernathys 50. Hunger Games. Lionsgate Mega Release.", type: "forecast", confirmed: true, confidence: 75, side: "right", size: "small" },
  { year: 2026, month: 12, day: 23, pillar: "pop", title: "Shrek 5", desc: "23. Dezember 2026. Erster Shrek Film seit 16 Jahren. DreamWorks Comeback. Original Cast zurück.", type: "forecast", confirmed: true, confidence: 72, side: "left", size: "small" },
  ...
  { year: 2027, month: 2, day: 7, pillar: "pop", title: "Super Bowl LXI", desc: "2. Sonntag im Februar. NFL Championship. Halftime Show wird Mega Event. 100+ Mio US Zuschauer.", type: "forecast", confirmed: true, confidence: 95, side: "right", size: "large" },
  { year: 2027, month: 5, day: 29, pillar: "pop", title: "Champions League Final 2027 Madrid", desc: "Endspiel im Santiago Bernabéu. Königliche Bühne des Fußballs. 1 Milliarde Zuschauer global.", type: "forecast", confirmed: true, confidence: 85, side: "left", size: "medium" },
  { year: 2027, month: 5, day: 22, pillar: "pop", title: "Star Wars: Starfighter", desc: "22. Mai 2027. Neuer Star Wars Mainline Film. Ryan Gosling als Lead. Era zwischen Rise of Skywalker und neuen Filmen.", type: "forecast", confirmed: true, confidence: 82, side: "right", size: "medium" },
  { year: 2027, month: 7, day: 31, pillar: "pop", title: "Spider-Man: Brand New Day", desc: "31. Juli 2027. Tom Holland zurück als Spider-Man. Erster Solo Film nach No Way Home. MCU Reboot Phase.", type: "forecast", confirmed: true, confidence: 85, side: "left", size: "medium" },
  ...
  { year: 2026, month: 11, day: 19, pillar: "pop", title: "GTA 6 Release", desc: "19. November 2026. Rockstars größtes Game aller Zeiten. Vice City Setting. Budget über 2 Mrd USD. Verschoben von Mai 2026 für Polish.", type: "forecast", confirmed: true, confidence: 95, side: "left", size: "large" },
  ...
  // ─── TV / STREAMING ─────────────────────────────────
  { year: 2026, month: 6, day: 21, pillar: "pop", title: "House of the Dragon S3", desc: "21. Juni 2026 HBO. 8 Episoden bis 9. August. Tanz der Drachen eskaliert. Game of Thrones Universe Höhepunkt.", type: "forecast", confirmed: true, confidence: 78, side: "right", size: "medium" },
  ...
  { year: 2026, month: 3, day: 8, pillar: "pop", title: "F1 2026 Saison Start Melbourne", desc: "Audi und Cadillac als neue Teams. Komplett neue Regeln: 50/50 Hybrid, Active Aero, Overtake Mode statt DRS. Größte Reform seit 2014.", type: "forecast", confirmed: true, confidence: 80, side: "right", size: "large" },
  ...
  { year: 2026, month: 4, day: 1, pillar: "tech", title: "Apple 50 Jahre", desc: "1. April 1976: Steve Jobs und Wozniak gründen Apple Computer Inc. 50 Jahre Personal Computing Revolution. Halbes Jahrhundert.", type: "forecast", confirmed: true, confidence: 75, side: "right", size: "medium" },
  { year: 2026, month: 4, day: 26, pillar: "culture", title: "Chernobyl 40 Jahre", desc: "26. April 1986: Reaktorunglück. 40 Jahre nach der größten zivilen Nuklearkatastrophe der Geschichte.", type: "forecast", confidence: 55, side: "left", size: "small" },
  ...
  // ─── ANNIVERSARIES 2027 ─────────────────────────────
  { year: 2027, month: 1, day: 9, pillar: "tech", title: "iPhone 20 Jahre", desc: "9. Januar 2007: Steve Jobs stellt iPhone vor. 20 Jahre Smartphone Revolution. Wendepunkt der Mensch-Technik-Beziehung.", type: "forecast", confirmed: true, confidence: 80, side: "left", size: "medium" },
  ...
  { year: 2026, month: 5, day: 30, pillar: "pop", title: "Champions League Final 2026 Budapest", desc: "Ferenc Puskás Aréna. Erste CL Final in Ungarn. Königsdisziplin des europäischen Klubfußballs.", type: "forecast", confirmed: true, confidence: 85, side: "right", size: "medium" },
  ...
  // ─── WEITERE WAHLEN ─────────────────────────────────
  { year: 2026, month: 4, day: 12, pillar: "culture", title: "Ungarn Wahl Orbán", desc: "12. April 2026. Viktor Orbán in Bedrängnis. Péter Magyar als ernster Herausforderer. Geopolitisch wichtig.", type: "forecast", confirmed: true, confidence: 70, side: "right", size: "small" },
