...
const TIMELINE_EVENTS = [
  ...
  // ═══════════════════════════════════════════════════════
  { year: 2026, month: 6, pillar: "pop", title: "FIFA World Cup 2026", desc: "Größte WM aller Zeiten. 48 Teams, 3 Länder: USA, Kanada, Mexiko. Finale im MetLife Stadium New Jersey.", type: "forecast", confirmed: true, side: "right", size: "large" },
  { year: 2027, month: 4, pillar: "culture", title: "Frankreich Présidentielle", desc: "Macrons zweite Amtszeit endet. Neuwahl entscheidet Europas politische Richtung für die nächste Dekade.", type: "forecast", confirmed: true, side: "left", size: "medium" },
  { year: 2027, month: 5, pillar: "pop", title: "Avengers: Secret Wars", desc: "Marvel Kino-Finale des Multiverse Saga. Offiziell angekündigt für Mai 2027. Größtes Ensemble der MCU Geschichte.", type: "forecast", confirmed: true, side: "right", size: "large" },
  { year: 2027, month: 10, pillar: "pop", title: "The Batman 2", desc: "Matt Reeves Sequel mit Robert Pattinson. Warner Bros bestätigt. Dunkler, psychologischer Noir Ansatz.", type: "forecast", confirmed: true, side: "left", size: "small" },
  { year: 2028, month: 7, pillar: "pop", title: "Olympische Spiele Los Angeles", desc: "Sommer 2028. LA Olympic Games. Erste Spiele in den USA seit Atlanta 1996. Neue Sportarten, Record Audience.", type: "forecast", confirmed: true, side: "right", size: "large" },
  { year: 2028, month: 11, pillar: "culture", title: "US Presidential Election", desc: "Nächste Wahl ins Weiße Haus. Nach zwei Trump Amtszeiten entscheidet sich die Richtung der USA für eine Generation.", type: "forecast", confirmed: true, side: "left", size: "large" },
  ...
  { year: 2030, month: 6, pillar: "pop", title: "FIFA World Cup 2030", desc: "100 Jahre WM Jubiläum. Austragungsorte: Spanien, Portugal, Marokko plus Argentinien und Uruguay. Historisches Event.", type: "forecast", confirmed: true, side: "left", size: "large" },
  { year: 2032, month: 7, pillar: "pop", title: "Olympische Spiele Brisbane", desc: "Sommer 2032 in Australien. Erste Spiele auf dem 5. Kontinent seit Sydney 2000. Nachhaltigkeitsfokus.", type: "forecast", confirmed: true, side: "right", size: "medium" },
  { year: 2034, month: 6, pillar: "pop", title: "FIFA World Cup 2034 Saudi Arabia", desc: "Erste WM im Mittleren Osten nach Katar. Saudi Vision 2030 im Sportwashing Finale. Klimatisch und politisch umstritten.", type: "forecast", confirmed: true, side: "left", size: "medium" },
  { year: 2036, month: 7, pillar: "pop", title: "Olympische Spiele 2036", desc: "Gastgeber noch offen. Indien und Deutschland bewerben sich. Letzte Spiele vor möglichem Formatwandel durch AI.", type: "forecast", confirmed: true, side: "right", size: "small" },
  ...
  { year: 2026, month: 5, pillar: "pop", title: "Avengers: Doomsday", desc: "Marvel Mega Film. Robert Downey Jr. kehrt als Doctor Doom zurück. Multiverse Saga Höhepunkt vor Secret Wars.", type: "forecast", confirmed: true, confidence: 95, side: "left", size: "large" },
  { year: 2026, month: 5, pillar: "pop", title: "Eurovision Song Contest Wien", desc: "Österreich Gastgeber nach JJs Sieg 2025. Wien Stadthalle. Über 200 Millionen Zuschauer global.", type: "forecast", confirmed: true, confidence: 75, side: "right", size: "medium" },
  { year: 2026, month: 5, pillar: "pop", title: "Bad Bunny im Madison Square Garden", desc: "4. Mai 2026. Erste US Stadion-Show nach Puerto Rico Residency die Demand Records brach.", type: "forecast", confirmed: true, confidence: 65, side: "left", size: "small" },
  ...
  { year: 2026, month: 5, pillar: "pop", title: "Star Wars: The Mandalorian & Grogu", desc: "22. Mai 2026. Erster Mandalorian Kinofilm. Pedro Pascal mit Baby Yoda zurück auf der Leinwand.", type: "forecast", confirmed: true, confidence: 80, side: "left", size: "medium" },
  ...
  { year: 2026, month: 7, pillar: "pop", title: "Christopher Nolan: The Odyssey", desc: "17. Juli 2026. Matt Damon als Odysseus. IMAX 70mm Epos nach Oppenheimer. Eines der wichtigsten Filme der Dekade.", type: "forecast", confirmed: true, confidence: 88, side: "right", size: "large" },
  ...
  { year: 2026, month: 8, pillar: "pop", title: "Coldplay Music of the Spheres Finale", desc: "22. August. Wembley Stadium London. Größte Tour der Bandgeschichte endet nach 4 Jahren und 200 Shows.", type: "forecast", confirmed: true, confidence: 70, side: "right", size: "medium" },
  ...
  { year: 2026, month: 10, pillar: "culture", title: "Brasilien Wahl 2026", desc: "Oktober. Lula vs Konservative. Amazonas Schutz, Wirtschaftskrise, soziale Programme zentral. 215 Mio Einwohner entscheiden.", type: "forecast", confirmed: true, confidence: 85, side: "left", size: "medium" },
  ...
  { year: 2026, month: 11, pillar: "culture", title: "US Midterm Elections", desc: "3. November. 435 House Sitze, 35 Senate Seats. Erste Bewertung der zweiten Trump Amtszeit. Indikator für 2028.", type: "forecast", confirmed: true, confidence: 95, side: "left", size: "large" },
  { year: 2026, month: 11, pillar: "pop", title: "Hunger Games: Sunrise on the Reaping", desc: "20. November. Prequel zu Catching Fire. Haymitch Abernathys 50. Hunger Games. Lionsgate Mega Release.", type: "forecast", confirmed: true, confidence: 75, side: "right", size: "small" },
  { year: 2026, month: 12, pillar: "pop", title: "Shrek 5", desc: "23. Dezember 2026. Erster Shrek Film seit 16 Jahren. DreamWorks Comeback. Original Cast zurück.", type: "forecast", confirmed: true, confidence: 72, side: "left", size: "small" },
  ...
  { year: 2027, month: 2, pillar: "pop", title: "Super Bowl LXI", desc: "2. Sonntag im Februar. NFL Championship. Halftime Show wird Mega Event. 100+ Mio US Zuschauer.", type: "forecast", confirmed: true, confidence: 95, side: "right", size: "large" },
  { year: 2027, month: 5, pillar: "pop", title: "Champions League Final 2027 Madrid", desc: "Endspiel im Santiago Bernabéu. Königliche Bühne des Fußballs. 1 Milliarde Zuschauer global.", type: "forecast", confirmed: true, confidence: 85, side: "left", size: "medium" },
  { year: 2027, month: 5, pillar: "pop", title: "Star Wars: Starfighter", desc: "22. Mai 2027. Neuer Star Wars Mainline Film. Ryan Gosling als Lead. Era zwischen Rise of Skywalker und neuen Filmen.", type: "forecast", confirmed: true, confidence: 82, side: "right", size: "medium" },
  { year: 2027, month: 7, pillar: "pop", title: "Spider-Man: Brand New Day", desc: "31. Juli 2027. Tom Holland zurück als Spider-Man. Erster Solo Film nach No Way Home. MCU Reboot Phase.", type: "forecast", confirmed: true, confidence: 85, side: "left", size: "medium" },
  ...
  { year: 2027, month: 12, pillar: "pop", title: "Star Wars Sequel Trilogy Follow-up", desc: "17. Dezember 2027. Daisy Ridley kehrt als Rey Skywalker zurück. New Jedi Order Story. Disney Mega Bet.", type: "forecast", confirmed: true, confidence: 82, side: "left", size: "large" },

  // ─── 2028 ─────────────────────────────────────────────
  { year: 2028, month: 2, pillar: "pop", title: "Super Bowl LXII", desc: "NFL Saison Finale. Halftime Show als Mega Pop Event. Werbeplätze über 10 Mio USD pro 30 Sekunden.", type: "forecast", confirmed: true, confidence: 95, side: "right", size: "medium" },
  ...
  { year: 2028, month: 3, pillar: "tech", title: "Artemis IV Mond Landung", desc: "Erste bemannte US Mondlandung seit Apollo 17 im Dezember 1972. SLS/Orion plus Starship HLS Lander. Historischer Moment.", type: "forecast", confirmed: true, confidence: 92, side: "right", size: "large" },
  { year: 2028, month: 6, pillar: "pop", title: "UEFA EURO 2028 UK & Irland", desc: "Juni bis Juli 2028. Wembley als Finale. Erste EM auf britischen Inseln seit 1996. England gegen Frankreich Klassiker erwartet.", type: "forecast", confirmed: true, confidence: 90, side: "left", size: "large" },
  ...
  { year: 2029, month: 7, pillar: "culture", title: "Apollo 11 60 Jahre Jubiläum", desc: "60 Jahre erste Mondlandung. Globale Feier. NASA dann mit Artemis Mondbasis im Aufbau. Symbolisch wichtiger Moment.", type: "forecast", confirmed: true, confidence: 55, side: "left", size: "small" },
  ...
  { year: 2031, month: 12, pillar: "pop", title: "Avatar 5", desc: "19. Dezember 2031. James Camerons fünfter und letzter angekündigter Avatar Film. Pandora Saga Schlusspunkt.", type: "forecast", confirmed: true, confidence: 80, side: "left", size: "large" },
  ...
  { year: 2028, month: 7, pillar: "crypto", title: "Bitcoin Halving 2028", desc: "Vierter Halving Cycle. Block Reward sinkt auf 1.5625 BTC. Historisch Vorläufer für Bull Runs. Knappheit verdoppelt.", type: "forecast", confirmed: true, confidence: 85, side: "left", size: "large" },
  ...
  { year: 2026, month: 11, pillar: "pop", title: "GTA 6 Release", desc: "19. November 2026. Rockstars größtes Game aller Zeiten. Vice City Setting. Budget über 2 Mrd USD. Verschoben von Mai 2026 für Polish.", type: "forecast", confirmed: true, confidence: 95, side: "left", size: "large" },
  { year: 2027, month: 11, pillar: "tech", title: "PlayStation 6 Launch", desc: "Holiday 2027. Sony Next-Gen Konsole. AMD Ryzen AI Cores, Pathtracing in Echtzeit. Generation Shift im Gaming.", type: "forecast", confidence: 82, side: "right", size: "large" },
  { year: 2027, month: 11, pillar: "tech", title: "Xbox Next-Gen Konsole", desc: "Microsoft Project Helix. Holiday 2027. Cloud-Hybrid First. Game Pass Integration vertieft. Konkurrenz zu PS6.", type: "forecast", confidence: 78, side: "left", size: "medium" },

  // ─── TV / STREAMING ─────────────────────────────────
  { year: 2026, month: 6, pillar: "pop", title: "House of the Dragon S3", desc: "21. Juni 2026 HBO. 8 Episoden bis 9. August. Tanz der Drachen eskaliert. Game of Thrones Universe Höhepunkt.", type: "forecast", confirmed: true, confidence: 78, side: "right", size: "medium" },
  ...
  { year: 2026, month: 3, pillar: "pop", title: "F1 2026 Saison Start Melbourne", desc: "Audi und Cadillac als neue Teams. Komplett neue Regeln: 50/50 Hybrid, Active Aero, Overtake Mode statt DRS. Größte Reform seit 2014.", type: "forecast", confirmed: true, confidence: 80, side: "right", size: "large" },
  { year: 2026, month: 9, pillar: "pop", title: "F1 Madrid Grand Prix Debut", desc: "September 2026. Erstes Madrid Stadtrennen. Streckenführung um IFEMA Convention Center. Imola raus, Madrid rein.", type: "forecast", confirmed: true, confidence: 65, side: "left", size: "small" },
  { year: 2026, month: 12, pillar: "pop", title: "F1 World Champion 2026 Abu Dhabi", desc: "4. bis 6. Dezember Finale. Erste komplette Saison mit neuen Regeln. Audi Debut Performance entscheidend.", type: "forecast", confirmed: true, confidence: 75, side: "right", size: "medium" },

  // ─── MUSIC TOURS 2026 (BESTÄTIGT) ───────────────────
  { year: 2026, month: 6, pillar: "pop", title: "BTS Arirang World Tour", desc: "Größte K-Pop Tour aller Zeiten. 82 Shows in 34 Städten 2026 bis 2027. Erste komplette Tour nach Militärdienst. Asia, NA, EU, SA.", type: "forecast", confirmed: true, confidence: 80, side: "left", size: "medium" },
  { year: 2026, month: 7, pillar: "pop", title: "Lady Gaga Mayhem Ball Tour", desc: "Sommer 2026 Nordamerika und Asien. Erste Tour seit Chromatica Ball 2022. Mayhem Album promoten.", type: "forecast", confirmed: true, confidence: 68, side: "right", size: "small" },
  ...
  { year: 2026, month: 5, pillar: "pop", title: "Bon Jovi Comeback Tour", desc: "Erste Welttournee nach Stimmband OP. Jon Bon Jovi mit komplettem Setlist Klassiker.", type: "forecast", confidence: 50, side: "left", size: "small" },
  ...
  // ─── CHINA SPACE PROGRAM ─────────────────────────────
  { year: 2026, month: 11, pillar: "tech", title: "Chang'e 7 Mondsüdpol Mission", desc: "Späte 2026. China Mondsüdpol Erkundung. Orbiter, Lander, fliegende Mini Sonde. Sucht Eis und Ressourcen.", type: "forecast", confirmed: true, confidence: 80, side: "right", size: "medium" },
  ...
  { year: 2029, month: 9, pillar: "tech", title: "China erste bemannte Mondlandung", desc: "2029 oder 2030. Mengzhou Crewed Spacecraft plus Lanyue Lander. Long March 10 Rakete. Symbolischer Sieg im Space Race.", type: "forecast", confidence: 78, side: "right", size: "large" },
  ...
  // ─── ANNIVERSARIES 2026 ─────────────────────────────
  { year: 2026, month: 1, pillar: "tech", title: "100 Jahre erste TV Demo", desc: "26. Januar 1926: John Logie Baird zeigt erste öffentliche TV Vorführung in London. 100 Jahre bewegte Bilder.", type: "forecast", confidence: 40, side: "left", size: "small" },
  { year: 2026, month: 2, pillar: "tech", title: "ENIAC 80 Jahre Computer", desc: "14. Februar 1946: Erster elektronischer Universalrechner. Geburtsstunde der Computerei. 80 Jahre Digital Era.", type: "forecast", confidence: 38, side: "right", size: "small" },
  { year: 2026, month: 3, pillar: "tech", title: "100 Jahre erste Flüssigtreibstoff Rakete", desc: "16. März 1926: Robert Goddard startet erste Flüssigtreibstoff Rakete. Vorläufer aller Raumfahrt. Symbolisches Jubiläum.", type: "forecast", confidence: 35, side: "left", size: "small" },
  { year: 2026, month: 4, pillar: "tech", title: "Apple 50 Jahre", desc: "1. April 1976: Steve Jobs und Wozniak gründen Apple Computer Inc. 50 Jahre Personal Computing Revolution. Halbes Jahrhundert.", type: "forecast", confirmed: true, confidence: 75, side: "right", size: "medium" },
  { year: 2026, month: 4, pillar: "culture", title: "Chernobyl 40 Jahre", desc: "26. April 1986: Reaktorunglück. 40 Jahre nach der größten zivilen Nuklearkatastrophe der Geschichte.", type: "forecast", confidence: 55, side: "left", size: "small" },
  { year: 2026, month: 5, pillar: "culture", title: "David Attenborough 100", desc: "8. Mai 1926: Geburt der TV Naturikone. 100 Jahre alt. Symbol für Naturschutz und Wissenschaftskommunikation.", type: "forecast", confidence: 50, side: "right", size: "small" },
  { year: 2026, month: 6, pillar: "pop", title: "Marilyn Monroe 100", desc: "1. Juni 1926: Norma Jeane Mortenson geboren. 100 Jahre Pop Culture Ikone. Globaler Glamour Mythos.", type: "forecast", confidence: 45, side: "left", size: "small" },
  { year: 2026, month: 8, pillar: "design", title: "World Wide Web 35", desc: "6. August 1991: Tim Berners-Lee veröffentlicht erstes Webseite Konzept. 35 Jahre WWW. Heute fast die Hälfte der Menschheit online.", type: "forecast", confidence: 50, side: "right", size: "small" },

  // ─── ANNIVERSARIES 2027 ─────────────────────────────
  { year: 2027, month: 1, pillar: "tech", title: "iPhone 20 Jahre", desc: "9. Januar 2007: Steve Jobs stellt iPhone vor. 20 Jahre Smartphone Revolution. Wendepunkt der Mensch-Technik-Beziehung.", type: "forecast", confirmed: true, confidence: 80, side: "left", size: "medium" },
  { year: 2027, month: 5, pillar: "culture", title: "Lindbergh 100 Jahre Atlantik", desc: "20. Mai 1927: Erster Solo Transatlantikflug. Spirit of St. Louis. 100 Jahre globale Mobilität.", type: "forecast", confidence: 40, side: "right", size: "small" },
  { year: 2027, month: 10, pillar: "tech", title: "Sputnik 70 Jahre", desc: "4. Oktober 1957: Sowjetunion startet ersten Satelliten. 70 Jahre Weltraumzeitalter. Beginn des Space Race.", type: "forecast", confidence: 45, side: "left", size: "small" },

  // ─── ANNIVERSARIES 2029 ─────────────────────────────
  { year: 2029, month: 10, pillar: "banking", title: "Black Tuesday 100 Jahre", desc: "29. Oktober 1929: Wall Street Crash. 100 Jahre nach Auslöser der Großen Depression. Lehre für Banking Regulierung.", type: "forecast", confidence: 50, side: "right", size: "small" },
  ...
  { year: 2026, month: 5, pillar: "pop", title: "Met Gala 2026", desc: "Erster Montag im Mai. Mode trifft Society. Annas Wintours letztes Comeback Theme erwartet. Instagram Apex Moment.", type: "forecast", confidence: 60, side: "left", size: "small" },
  ...
  { year: 2026, month: 5, pillar: "pop", title: "Champions League Final 2026 Budapest", desc: "Ferenc Puskás Aréna. Erste CL Final in Ungarn. Königsdisziplin des europäischen Klubfußballs.", type: "forecast", confirmed: true, confidence: 85, side: "right", size: "medium" },
  { year: 2027, month: 7, pillar: "pop", title: "FIFA Frauen WM 2027 Brasilien", desc: "Erste Frauen Weltmeisterschaft in Südamerika. Brasilien als Gastgeber. Frauenfußball Boom hält an.", type: "forecast", confirmed: true, confidence: 80, side: "left", size: "medium" },
  ...
  // ─── WEITERE WAHLEN ─────────────────────────────────
  { year: 2026, month: 4, pillar: "culture", title: "Ungarn Wahl Orbán", desc: "12. April 2026. Viktor Orbán in Bedrängnis. Péter Magyar als ernster Herausforderer. Geopolitisch wichtig.", type: "forecast", confirmed: true, confidence: 70, side: "right", size: "small" },
